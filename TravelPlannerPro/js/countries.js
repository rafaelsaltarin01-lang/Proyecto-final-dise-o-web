...
async function fetchCountryData(countryName) {
    ...
    // BASE DE DATOS GEOGRÁFICA LOCAL 
    ...
    try {
        ...
        const response = await fetch(`https://api.geoapify.com/v1/geocode/search?text=${encodeURIComponent(countryName)}&type=country&format=json&apiKey=b0049d517244423bac5ef703d43d4320`);
